...
{
    /// <inheritdoc />
    public partial class _20251002155551 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangeValues = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VETERNAY_DISEASE", x => x.Id);
                    table.UniqueConstraint("AK_VETERNAY_DISEASE_Guid", x => x.Guid);
                });

            migrationBuilder.CreateTable(
                name: "VETERNAY_DISEASETYPE",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VETERNAY_DISEASETYPE", x => x.Id);
                    table.UniqueConstraint("AK_VETERNAY_DISEASETYPE_Guid", x => x.Guid);
                });

            migrationBuilder.CreateTable(
                name: "VETERNAY_MEDICATION",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VETERNAY_MEDICATION", x => x.Id);
                    table.UniqueConstraint("AK_VETERNAY_MEDICATION_Guid", x => x.Guid);
                });

            migrationBuilder.CreateTable(
                name: "VETERNAY_PET_TYPE",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VETERNAY_PET_TYPE", x => x.Id);
                    table.UniqueConstraint("AK_VETERNAY_PET_TYPE_Guid", x => x.Guid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityVeternayCustomerId = table.Column<int>(type: "int", nullable: false),
                    ...
                    EntityVeternayDiseaseTypeId = table.Column<int>(type: "int", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserCreated = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserModified = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VETERNAY_PET_VETERNAY_DISEASETYPE_EntityVeternayDiseaseTypeId",
                        column: x => x.EntityVeternayDiseaseTypeId,
                        principalTable: "VETERNAY_DISEASETYPE",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VETERNAY_PET_VETERNAY_PET_TYPE_PetTypeId",
                        column: x => x.PetTypeId,
                        principalTable: "VETERNAY_PET_TYPE",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "VETERNAY_MEDICAL_RECORD",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VETERNAY_MEDICAL_RECORD", x => x.Id);
                    table.UniqueConstraint("AK_VETERNAY_MEDICAL_RECORD_Guid", x => x.Guid);
                    table.ForeignKey(
                        name: "FK_VETERNAY_MEDICAL_RECORD_VETERNAY_PET_PetId",
                        column: x => x.PetId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuidMedicalRecord = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VETERNAY_BOOKING_VETERNAY_MEDICAL_RECORD_MedicalRecordId",
                        column: x => x.MedicalRecordId,
                        principalTable: "VETERNAY_MEDICAL_RECORD",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "VETERNAY_MEDICAL_ATTACHMENT",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GuidMedicalRecord = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalRecordId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VETERNAY_MEDICAL_ATTACHMENT", x => x.Id);
                    table.UniqueConstraint("AK_VETERNAY_MEDICAL_ATTACHMENT_Guid", x => x.Guid);
                    table.ForeignKey(
                        name: "FK_VETERNAY_MEDICAL_ATTACHMENT_VETERNAY_MEDICAL_RECORD_MedicalRecordId",
                        column: x => x.MedicalRecordId,
                        principalTable: "VETERNAY_MEDICAL_RECORD",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuidMedicalRecord = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalRecordId = table.Column<int>(type: "int", nullable: true),
                    GuidDiseaseType = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DiseaseTypeId = table.Column<int>(type: "int", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserCreated = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserModified = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VETERNAY_MEDICAL_DISEASE", x => x.Id);
                    table.UniqueConstraint("AK_VETERNAY_MEDICAL_DISEASE_Guid", x => x.Guid);
                    table.ForeignKey(
                        name: "FK_VETERNAY_MEDICAL_DISEASE_VETERNAY_DISEASETYPE_DiseaseTypeId",
                        column: x => x.DiseaseTypeId,
                        principalTable: "VETERNAY_DISEASETYPE",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VETERNAY_MEDICAL_DISEASE_VETERNAY_MEDICAL_RECORD_MedicalRecordId",
                        column: x => x.MedicalRecordId,
                        principalTable: "VETERNAY_MEDICAL_RECORD",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "VETERNAY_MEDICAL_PRESCRIPTION",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    GuidMedicalRecord = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalRecordId = table.Column<int>(type: "int", nullable: true),
                    GuidMedication = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VETERNAY_MEDICAL_PRESCRIPTION", x => x.Id);
                    table.UniqueConstraint("AK_VETERNAY_MEDICAL_PRESCRIPTION_Guid", x => x.Guid);
                    table.ForeignKey(
                        name: "FK_VETERNAY_MEDICAL_PRESCRIPTION_VETERNAY_MEDICAL_RECORD_MedicalRecordId",
                        column: x => x.MedicalRecordId,
                        principalTable: "VETERNAY_MEDICAL_RECORD",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VETERNAY_MEDICAL_PRESCRIPTION_VETERNAY_MEDICATION_MedicationId",
                        column: x => x.MedicationId,
                        principalTable: "VETERNAY_MEDICATION",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuidMedicalRecord = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalRecordId = table.Column<int>(type: "int", nullable: true),
                    GuidService = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VETERNAY_MEDICAL_SERVICE", x => x.Id);
                    table.UniqueConstraint("AK_VETERNAY_MEDICAL_SERVICE_Guid", x => x.Guid);
                    table.ForeignKey(
                        name: "FK_VETERNAY_MEDICAL_SERVICE_VETERNAY_MEDICAL_RECORD_MedicalRecordId",
                        column: x => x.MedicalRecordId,
                        principalTable: "VETERNAY_MEDICAL_RECORD",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VETERNAY_MEDICAL_SERVICE_VETERNAY_SERVICES_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VETERNAY_BOOKING_SERVICE", x => x.Id);
                    table.UniqueConstraint("AK_VETERNAY_BOOKING_SERVICE_Guid", x => x.Guid);
                    table.ForeignKey(
                        name: "FK_VETERNAY_BOOKING_SERVICE_VETERNAY_BOOKING_BookingId",
                        column: x => x.BookingId,
                        principalTable: "VETERNAY_BOOKING",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VETERNAY_BOOKING_SERVICE_VETERNAY_SERVICES_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "VETERNAY_SERVICES",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_BOOKING_MedicalRecordId",
                table: "VETERNAY_BOOKING",
                column: "MedicalRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_BOOKING_SERVICE_BookingId",
                table: "VETERNAY_BOOKING_SERVICE",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_BOOKING_SERVICE_ServiceId",
                table: "VETERNAY_BOOKING_SERVICE",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_MEDICAL_ATTACHMENT_MedicalRecordId",
                table: "VETERNAY_MEDICAL_ATTACHMENT",
                column: "MedicalRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_MEDICAL_DISEASE_DiseaseTypeId",
                table: "VETERNAY_MEDICAL_DISEASE",
                column: "DiseaseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_MEDICAL_DISEASE_MedicalRecordId",
                table: "VETERNAY_MEDICAL_DISEASE",
                column: "MedicalRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_MEDICAL_PRESCRIPTION_MedicalRecordId",
                table: "VETERNAY_MEDICAL_PRESCRIPTION",
                column: "MedicalRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_MEDICAL_PRESCRIPTION_MedicationId",
                table: "VETERNAY_MEDICAL_PRESCRIPTION",
                column: "MedicationId");

            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_MEDICAL_RECORD_PetId",
                table: "VETERNAY_MEDICAL_RECORD",
                column: "PetId");

            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_MEDICAL_SERVICE_MedicalRecordId",
                table: "VETERNAY_MEDICAL_SERVICE",
                column: "MedicalRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_MEDICAL_SERVICE_ServiceId",
                table: "VETERNAY_MEDICAL_SERVICE",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_PET_EntityVeternayDiseaseTypeId",
                table: "VETERNAY_PET",
                column: "EntityVeternayDiseaseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_VETERNAY_PET_PetTypeId",
                table: "VETERNAY_PET",
                column: "PetTypeId");
        }
