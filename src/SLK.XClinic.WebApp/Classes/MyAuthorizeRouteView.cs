...
/// </summary>
public sealed class MyAuthorizeRouteView : RouteView
{
    ...
    [Parameter]
    public Type LoadingLayout { get; set; }
    ...
    private void RenderNotAuthorizedInDefaultLayout(RenderTreeBuilder builder, AuthenticationState authenticationState)
    {
        ...
        // switch to my own layout for best view when not authorized
        builder.OpenComponent<LayoutView>(0);
        builder.AddAttribute(1, nameof(LayoutView.Layout), LoadingLayout);
        builder.AddAttribute(2, nameof(LayoutView.ChildContent), content(authenticationState));
        builder.CloseComponent();
    }
    ...
    private void RenderAuthorizingInDefaultLayout(RenderTreeBuilder builder)
    {
        ...
        // switch to my own layout for best view when loading
        builder.OpenComponent<LayoutView>(0);
        builder.AddAttribute(1, nameof(LayoutView.Layout), LoadingLayout);
        builder.AddAttribute(2, nameof(LayoutView.ChildContent), content);
        builder.CloseComponent();
    ...
    private class AuthorizeRouteViewCore : AuthorizeViewCore
    {
        ...
        protected override IAuthorizeData[] GetAuthorizeData()
            => MyAttributeAuthorizeDataCache.GetAuthorizeDataForType(RouteData.PageType);
    }
}